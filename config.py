...
class Config:
    ...
    if platform == "heroku":
        SQLALCHEMY_DATABASE_URI = (
            ...
            or "postgresql://localhost:5432/hazen"
        )
        ...
        SQLALCHEMY_DATABASE_URI = (
            f"postgresql+psycopg2://{pg_user}:{pg_pw}@hazen_db:5432/{pg_db}"
        )
        ...
        SQLALCHEMY_DATABASE_URI = (
            os.environ.get("DATABASE_URL") or "postgresql://localhost:5432/hazen"
        )
    ...
    DROPZONE_ALLOWED_FILE_TYPE = "application/dicom, .IMA, .dcm"
