...
Therefore, the agreement between a nominal slice position and the measured slice position is calculated from 60 appropriately acquired coronal images. The inserts as seen in the image below should be positioned vertically for the script to function.
